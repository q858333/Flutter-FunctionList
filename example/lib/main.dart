...
class _MyAppState extends State<_MyApp> {
  ...
  Future<void> initStoreInfo() async {
    ...
    print('object=productDetailResponse=$productDetailResponse   | ${productDetailResponse.error}');
    ...
    print("_queryProductError=$_queryProductError  | ${productDetailResponse?.error} | ${productDetailResponse?.productDetails} | ${productDetailResponse?.notFoundIDs}");
